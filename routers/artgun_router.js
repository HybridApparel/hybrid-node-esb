...
artGunRouter.get('/orders/:orderID/packslip', function(req, res) {
  ...
  Order.findOne({
      ...
      templateSourceJSON.billing_name2 = sourceBodyJSON.coBillingName;
      ...
      templateSourceJSON.shipping_name2 = sourceBodyJSON.coShippingName;
      ...
      templateSourceJSON.date = sourceBodyJSON.orderJSON.time.substr(0,sourceBodyJSON.orderJSON.indexOf(' '));
