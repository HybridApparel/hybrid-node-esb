...
artGunRouter.get('/orders/shipment', function(req, res) {
  ...
  var html = fs.readFileSync('../public/packSlipTest.html', 'utf8', {root: __dirname});
  var options = { format: 'Letter', orientations: 'landscape' };
  
  pdf.create(html, options).toFile('../public/packing_slips/packSlipTest.pdf', function(err, res) {
