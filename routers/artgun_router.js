...
artGunRouter.get('/orders/:orderID/packslip', function(req, res) {
  ...
  Order.findOne({
      ...
      templateSourceJSON.orderTotal = Globalize.currencyFormatter("USD")((parseInt(merchTotal) + parseInt(templateSourceJSON.shippingCharge) + parseInt(sourceBodyJSON.orderJSON.items_tax)));
