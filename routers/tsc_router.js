...
TSCRouter.get('/orders/:orderID/packslip', function(req, res) {
  ...
  Order.findOne({
      ...
      templateSourceJSON.orderTotal = Globalize.currencyFormatter("USD")(parseFloat(templateSourceJSON.merchandiseTotal) + parseFloat(templateSourceJSON.shippingCharge) + parseFloat(stemplateSourceJSON.items_tax));
